...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "MrIBmrfpkpwp9XqiM4SR3aPDa",
    "consumer_secret"     :  "x87lUhZnVWrMDE9AIl884qI12mI71iiDcCtzeyhYFWdqI4ltBt",
    "access_token"        :  "931129378074955777-y0mMdMM2FUpLo8J7MQLhzsAHkEHpYH4",
    "access_token_secret" :  "Ttj9xTxTCeWGlRBSYlra2R7kISpB4T5znxO5A7SydB4hT"
}
...
class Tweets(Spout):
    ...
    def next_tuple(self):
        try:
            tweet = self.queue().get(timeout = 5)
            if tweet:
